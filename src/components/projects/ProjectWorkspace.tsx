...
export default function ProjectWorkspace({
  ...
  return (
    <>
      {isAdmin ? (
        <section className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-md p-6 shadow-sm">
          <SectionHeader
            title="Project"
          ...
          <form onSubmit={handleProjectUpdate} className="mt-6 space-y-4">
            <div className="grid gap-4 lg:grid-cols-[1fr_1.2fr]">
              <label className="block text-sm font-medium text-slate-300">
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none focus:border-blue-400 placeholder-slate-500"
            ...
            <div className="flex flex-wrap gap-3">
              <button
                type="submit"
                disabled={projectLoading || projectDeleteLoading}
                className="rounded-full bg-blue-600 px-5 py-2 text-sm font-semibold text-white hover:bg-blue-700 transition disabled:opacity-60"
              >
              ...
              <button
                ...
                disabled={projectLoading || projectDeleteLoading}
                className="rounded-full border border-red-500/30 bg-red-500/10 px-5 py-2 text-sm font-semibold text-red-400 hover:bg-red-500/20 transition disabled:opacity-60"
              >
            ...
            <form onSubmit={handleAddMember} className="mt-6 space-y-3">
              <div className="grid gap-3 md:grid-cols-[1fr_140px]">
                <input
                  ...
                  className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder-slate-500 outline-none focus:border-blue-400"
                ...
                <select
                  ...
                  className="rounded-2xl border border-white/10 bg-[#0f172a] px-4 py-3 text-sm text-white outline-none focus:border-blue-400"
                  disabled={memberLoading}
                >
            ...
            <>
              ...
              <form onSubmit={handleCreateTask} className="mt-6 space-y-3">
                <input
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white placeholder-slate-500 outline-none focus:border-blue-400"
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  <input
                    ...
                    className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none focus:border-blue-400 [color-scheme:dark]"
                    disabled={taskLoading}
                  />
                  <select
            ...
            {tasks.map((task) => (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <span className="rounded-full bg-blue-500/15 px-2 py-1 text-[11px] font-semibold text-blue-300">
                    {task.status}
                  </span>
                </div>
